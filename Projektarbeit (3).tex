...
Außerdem stehe ein Lexikon die folgenden Wörter (bzw. terminalen Symbole) zur Verfügung (hier der Einfachheit halber direkt als Produktionsregeln dargestellt):
\newline
\\
\tt
V $\rightarrow$ can\\
