...
\draw[->] (e) to (end);
\end{tikzpicture}
\caption{UML-Aktivitätsdiagramm User-Workflow mit dem Tool}
\end{figure}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.5]{C:/Users/Nutzer/OneDrive/Studium/Projektarbeit/Projektarbeit/GATE_Bilder/NLPSystem.jpg}
\includegraphics[scale=0.5]{GATE_Bilder/NLPSystem.jpg}
\caption{Usability- und Sicherheitsaspekte aus \cite{hl13}}
\end{center}
\end{figure} 
\end{comment}
Im Sinne der \textit{Informationssicherheit} \cite{eck13} muss bei der Entwicklung ein Fokus auf die folgenden "Kernschutzziele" gelegt werden:
\begin{enumerate}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.7]{C:/Users/Nutzer/OneDrive/Studium/Projektarbeit/Projektarbeit/GATE_Bilder/CREOLE.jpg}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=1.0]{C:/Users/Nutzer/OneDrive/Studium/Projektarbeit/Projektarbeit/GATE_Bilder/POSTagger.jpg}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=1.0]{C:/Users/Nutzer/OneDrive/Studium/Projektarbeit/Projektarbeit/GATE_Bilder/PluginOrdner.jpg}
\includegraphics[scale=0.55]{C:/Users/Nutzer/OneDrive/Studium/Projektarbeit/Projektarbeit/GATE_Bilder/PluginOrdner.jpg}
...
Ermöglichung für den User über eine Funktion, Ergebnisse von verschiedenen Verarbeitungsdurchgängen zu vergleichen, um Determinismus sicherzustellen (Funktionale Anforderung).
\begin{comment}
Anforderung: Das NLP-Tool sollte den Entwickler bei der Kontrolle von funktionaler Sicherheit unterstützen und ermöglichen das ordnungsgemäße Arbeiten verschiedener Funktionen zu überwachen und zu testen. 
\end{comment}
...
Als JAVA-basiertes Programm erhält GATE die entsprechenden Sicherheitsvorteile, welche unter anderem die folgenden Sicherheitsmaßnahmen beinhalten:
\begin{enumerate}
...
\bibitem[WEI66]{wei66}Joseph Weizenbaum, "ELIZA—a computer program for the study of natural language communication between man and machine." Communications of the ACM 9.1, 36-45, 1966
...
\bibitem[SB88]{sb88}Muggleton, Stephen, and Wray Buntine. "Machine invention of first-order predicates by inverting resolution." Machine Learning Proceedings 1988. 1988. 339-352
\bibitem[KN85]{kn85}Kapur, Deepak, and Paliath Narendran. "An equational approach to theorem proving in first-order predicate calculus." ACM SIGSOFT Software Engineering Notes 10.4 (1985): 63-66
\bibitem[BAL98]{bal98}Balzert, Helmut. "Software-Qualitätssicherung." Lehrbuch der Software-Technik. Spektrum Akadem. Verlag (1998)
...
\bibitem[CMB02]{cmb02} Cunningham, Hamish, et al. "GATE: an architecture for development of robust HLT applications." Proceedings of the 40th annual meeting on association for computational linguistics. Association for Computational Linguistics, 2002
...
\bibitem[MIL95]{mil95}Miller, George A. "WordNet: a lexical database for English." Communications of the ACM 38.11 (1995): 39-41.
\bibitem[CC98]{cc98}Claudia Leacock, Martin Chodorow. "Combining local context and WordNet similarity for word sense identification." WordNet: An electronic lexical database 49.2 (1998): 265-283
\bibitem[CU97]{cu97}Cunningham, Hamish, et al. "GATE–a TIPSTER-based general architecture for text engineering." Proceedings of the TIPSTER Text Program (Phase III). Vol. 6. 1997
\bibitem[CU02]{cu02}Cunningham, Hamish. "GATE, a general architecture for text engineering." Computers and the Humanities 36.2 (2002): 223-254.
\end{thebibliography}
\end{document}
