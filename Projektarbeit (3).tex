...
Es stellt sich ferner die Frage, wie relevant die semntische Analyse von Texten relevant ist und wie dann Wissen aus der Welt und natürliche Sprache im Computer effizient modelliert werden kann. 
...
Die Grundlage für den Algorithmus sind dann die Knoten zwischen Wörtern, im Beispiel in Abb. 2.3. \\
\begin{figure}[h!]
\begin{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.7]{GATE_Bilder/ANNIE2.jpg}
