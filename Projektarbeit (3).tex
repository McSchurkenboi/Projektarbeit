...
\section{User-Interaktion mit NLP-Tools}
Die Modellierung der Interaktion der Software mit Usern stellt eine Grundlage für die Erhebung weiterer Anforderungen dar, die nicht die verwendeten Algorithmen für die Sprachanalyse betreffen. In Kapitel 2 wurden diese funktionalen Bestandteile einer NLP-Software  bereits ausführlich erläutert.
Im folgenden Abschnitt soll nun prototypisch der Workflow von Usern, die ein Programm mit einer generellen NLP-Architektur verwenden, veranschaulicht werden. Mithilfe eines Aktivitätsdiagramms werden einerseits die Arbeitsumgebung, in der NLP-Tools zum Einsatz kommen und andererseits die spezifischen Interaktionspunkte der User mit diesem Programm beschrieben. Die Darstellung des Workflows soll in dieser Arbeit eher allgemeingültig erfolgen, da jede mögliche Anwendungsdomäne des Tools eigene Spezifika bei der Darstellung ihrer Arbeitsumgebung bereithält. Diese Besonderheiten betreffen dann auch die Darstellung und Abfolge der Interaktionsschritte und konkretisieren diese etwa auf einen speziellen Dokumententyp. Ein prototypisches Szenario bei der Verwendung eines NLP-Tools könnte etwa wie folgt aussehen:



Zur weiteren Definition und Einordnung der späteren Programmnutzer in Gruppen, wird anschließend in einem Use-Case-Diagramm die eher praktische und weniger technische Beschreibung verschiedener User-Anwendungsfälle erstellt. Die unterschiedlichen an NLP-Tools beteiligten Akteure aus einem betrieblichen Kontext werden in diesem näher beschrieben. Aus diesen Use-Cases der verschiedenen Stakeholder können im Anschluss konkrete Anforderungen an die Implementierung extrahiert werden, die nicht die technische Umsetzung der Software betreffen.
