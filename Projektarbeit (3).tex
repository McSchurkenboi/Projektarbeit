...
>>>>>>> 0e840ebb2970a088261a419e6d3891043337a556
...
\item 
ChartParse: \\
for each Wort $w_{0-n}$ im Satz, sei \textit{from} der linke und \textit{to} der rechte Knoten und daughters ds ein w \\
...
\rm(so einzeichnen, dass die Kante jeweils  eine bekannte Regel zur Verbindung zwischen zwei Knoten enthält, also $to_{1}=from_{2}$ usw.)\tt \\
